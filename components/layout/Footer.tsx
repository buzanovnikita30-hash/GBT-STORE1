    ...
    <footer className="border-t border-white/10 bg-[#070b14] py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-sm text-sm text-muted-foreground">
              ChatGPT Plus и Spotify Premium на ваш аккаунт — оплата в рублях, без иностранной карты.
            </p>
            <a
        ...
        <p className="mt-10 text-center text-xs text-muted-foreground md:text-left">
          © {new Date().getFullYear()} SubРФ. Все права защищены.
        </p>
      </div>
    </footer>
  );
